...
const ProposedTable = (props: any) => {

    const proposedData = props.data
    ...
    const totalPage = Math.ceil(proposedData.length / itemsPerPage)
        ...
        return (
            <TableContainer>
                <Table>
                    ...
                    <tbody>
                    {proposedData.length > 0 && proposedData.map((key: any, index: any) => (
