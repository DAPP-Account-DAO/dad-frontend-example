...
const ImplementedTable = (props: any) => {

    const implementedData = props.data
    ...
    const totalPage =  Math.ceil(implementedData.length / itemsPerPage)
        ...
        return (
            <TableContainer>
                <Table>
                    ...
                    <tbody>
                    {implementedData.length > 0 && implementedData.map((key: any, index: any) => (
