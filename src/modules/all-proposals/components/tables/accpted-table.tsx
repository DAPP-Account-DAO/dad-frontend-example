...
const AcceptedTable = (props: any) => {

    const acceptedData = props.data
    ...
    const totalPage = Math.ceil(acceptedData.length / itemsPerPage)
        ...
        return (
            <TableContainer>
                <Table>
                    ...
                    <tbody>
                    {acceptedData.length > 0 && acceptedData.map((key: any, index: any) => (
